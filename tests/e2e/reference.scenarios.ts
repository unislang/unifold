...
export const compositionNodeIds = {
  ...
  accountAttachments: "profile-editor::account-attachments",
  accountSummaryPopover: "profile-editor::account-summary-popover",
  accountBreadcrumb: "profile-editor::account-breadcrumb",
  accountReviewDialog: "profile-editor::account-review-dialog",
  ...
  communicationPreferences: "profile-editor::communication-preferences",
  country: "profile-editor::country",
  dynamicHelp: "profile-editor::dynamic-help",
  form: "profile-editor::form",
  formErrors: "profile-editor::form-errors",
  ...
  secondaryEmail: "profile-editor::secondary-email",
  root: "profile-editor",
