...
registry, wraps the source in an exact `UiModule@1.0.0`, and resolves its deterministic artifact
before mounting. The example uses `layoutType`, typed `variables`,
