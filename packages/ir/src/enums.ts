...
export enum DiagnosticCode {
  ...
  DuplicatePaginationItemId = "duplicate-pagination-item-id",
  DuplicatePaginationItemKind = "duplicate-pagination-item-kind",
  DuplicateOptionSelection = "duplicate-option-selection",
  ...
  InvalidErrorSummaryTarget = "invalid-error-summary-target",
  ...
  InvalidPaginationCurrent = "invalid-pagination-current",
  InvalidPaginationItem = "invalid-pagination-item",
  MissingRequiredProperty = "missing-required-property",
  MissingPaginationCurrent = "missing-pagination-current",
  ...
  UnknownErrorSummaryTarget = "unknown-error-summary-target",
